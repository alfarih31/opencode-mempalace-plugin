...
Output: `dist/index.js` (single-file ESM bundle targeting Node)
...
├── LICENSE                          # MIT
├── README.md                        # This file
└── opencode-plugin-mempalace/       # Plugin package
    ├── package.json                 # NPM package config
    ├── tsconfig.json                # TypeScript config
    ├── README.md                    # Package-level docs
    ├── src/
    │   └── index.ts                 # Single-file plugin (439 lines)
    └── dist/
